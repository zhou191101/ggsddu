...
public class NumLengthRegex {
	...
	private static final Pattern pattern = Pattern
			.compile("^000860[1][3-9][0-9]{9}$|^0000010[0-9]{10}$|^00088600[0-9]{9}|^000852000([6|9])[0-9]{7}|^00085300000([6|8])[0-9]{5}");
	...
	public static void main(String[] args){
		...
		System.out.println(pattern.matcher(num3).matches());
		System.out.println(pattern.matcher(num4).matches());
		System.out.println(pattern.matcher(num5).matches());
